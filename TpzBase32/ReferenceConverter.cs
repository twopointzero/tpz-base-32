...
{
    /// <summary>
    /// The ReferenceConverter class provides a tpz-base-32 encoding and
    /// decoding implementation designed for code clarity and to provide
    /// a solid reference implementation for optimized converters.
    /// (For a higher-performance converter dedicated to the processing
    /// of Int32 values, refer to the Int32Converter class.)
