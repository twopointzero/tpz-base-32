...
namespace twopointzero.TpzBase32Tests.TpzBase32ConverterHelperTests
{
    ...
    public class ConvertInt32ToBitEnumerable
    {
        ...
        public void GivenFortyTwoShouldReturnTheExpectedResult()
        {
            ...
            expected[3] = true;
            expected[5] = true;
            var actual = TpzBase32ConverterHelper.ConvertToBitEnumerable(42);
        ...
        public void GivenMinusOneShouldReturnTheExpectedResult()
        {
            ...
            var actual = TpzBase32ConverterHelper.ConvertToBitEnumerable(-1);
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        public void GivenMinusTwoShouldReturnTheExpectedResult()
        {
            ...
            var actual = TpzBase32ConverterHelper.ConvertToBitEnumerable(-2);
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        public void GivenZeroShouldReturnTheExpectedResult()
        {
            ...
            var actual = TpzBase32ConverterHelper.ConvertToBitEnumerable(0);
            CollectionAssert.AreEqual(expected, actual);
        }
