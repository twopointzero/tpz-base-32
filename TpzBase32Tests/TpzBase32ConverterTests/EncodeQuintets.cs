...
namespace twopointzero.TpzBase32Tests.TpzBase32ConverterTests
{
    ...
    public class EncodeQuintets
    {
        ...
        public void GivenANumberOfLegalValuesAndAtLeastOneIllegalValueShouldThrowArgumentOutOfRangeException()
        {
            ...
            var actual = TpzBase32Converter.EncodeQuintets(input);
        ...
        public void GivenASingleIllegalValueShouldThrowArgumentOutOfRangeException()
        {
            ...
            Assert.Throws<ArgumentOutOfRangeException>(
                () => TpzBase32Converter.EncodeQuintets(new[] { (byte)42 }).ToArray());
        }
        ...
        public void GivenASingleLegalValueShouldReturnASingleEncodedValue()
        {
            ...
            for (byte i = 0; i < values.Length; i++)
            {
                ...
                var actual = TpzBase32Converter.EncodeQuintets(new[] { i });
                CollectionAssert.AreEqual(expected, actual);
            }
        }
        ...
        {
            CollectionAssert.IsEmpty(TpzBase32Converter.EncodeQuintets(Enumerable.Empty<byte>()));
        }

        [Test]
        public void GivenNullShouldThrowArgumentNullException()
        {
            Assert.Throws<ArgumentNullException>(() => TpzBase32Converter.EncodeQuintets(null));
        }
    }
}