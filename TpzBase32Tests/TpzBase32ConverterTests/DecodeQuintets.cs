...
namespace twopointzero.TpzBase32Tests.TpzBase32ConverterTests
{
    ...
    public class DecodeQuintets
    {
        ...
        public void GivenANumberOfLegalValuesAndAtLeastOneIllegalValueShouldThrowArgumentOutOfRangeException()
        {
            ...
            var actual = TpzBase32Converter.DecodeQuintets(input);
        ...
        public void GivenASingleIllegalValueShouldThrowArgumentOutOfRangeException()
        {
            ...
            Assert.Throws<ArgumentOutOfRangeException>(
                () => TpzBase32Converter.DecodeQuintets(new[] { '!' }).ToArray());
        }
        ...
        public void GivenASingleLegalValueShouldReturnASingleDecodedValue()
        {
            ...
            {
                var expected = new[] { i };
                var actual = TpzBase32Converter.DecodeQuintets(new[] { values[i] });
                CollectionAssert.AreEqual(expected, actual);
            }
        }
        ...
        {
            CollectionAssert.IsEmpty(TpzBase32Converter.DecodeQuintets(Enumerable.Empty<char>()));
        }

        [Test]
        public void GivenNullShouldThrowArgumentNullException()
        {
            Assert.Throws<ArgumentNullException>(() => TpzBase32Converter.DecodeQuintets(null));
        }
    }
}