...
namespace twopointzero.TpzBase32Tests.TpzBase32ConverterTests
{
    ...
    public class ConvertBitEnumerableToIntEnumerable
    {
        ...
        public void GivenSixtyFiveValuesShouldReturnAnEnumerableThatProducesTheThreeExpectedResults()
        {
            ...
            var actual = TpzBase32Converter.ConvertToIntEnumerable(input);
        ...
        {
            CollectionAssert.IsEmpty(TpzBase32Converter.ConvertToIntEnumerable(Enumerable.Empty<bool>()));
        }
        ...
        {
            var expected = new[] { 2 };
            var actual = TpzBase32Converter.ConvertToIntEnumerable(new[] { false, true });
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        public void GivenThirtyTwoValuesShouldReturnAnEnumerableThatProducesTheOneExpectedNegativeResult()
        {
            ...
            var actual = TpzBase32Converter.ConvertToIntEnumerable(input).ToArray();
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => TpzBase32Converter.ConvertToIntEnumerable(null));
        }
        ...
        {
            var expected = new[] { 0 };
            var actual = TpzBase32Converter.ConvertToIntEnumerable(new[] { false });
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        {
            var expected = new[] { 1 };
            var actual = TpzBase32Converter.ConvertToIntEnumerable(new[] { true });
            CollectionAssert.AreEqual(expected, actual);
        }
