...
{
    [TestFixture]
    public class ConvertInt32ToEnumerableOfBoolean
    {
        [Test]
        public void GivenFortyTwoShouldReturnTheExpectedResult()
        {
            ...
            expected[3] = true;
            expected[5] = true;
            var actual = TpzBase32Converter.ConvertInt32ToEnumerableOfBoolean(42);
        ...
        public void GivenMinusOneShouldReturnTheExpectedResult()
        {
            ...
            var actual = TpzBase32Converter.ConvertInt32ToEnumerableOfBoolean(-1);
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        public void GivenMinusTwoShouldReturnTheExpectedResult()
        {
            ...
            var actual = TpzBase32Converter.ConvertInt32ToEnumerableOfBoolean(-2);
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        public void GivenZeroShouldReturnTheExpectedResult()
        {
            ...
            var actual = TpzBase32Converter.ConvertInt32ToEnumerableOfBoolean(0);
            CollectionAssert.AreEqual(expected, actual);
        }
