...
namespace twopointzero.TpzBase32Tests.TpzBase32ConverterTests
{
    ...
    public class ConvertBitEnumerableToQuintetEnumerable
    {
        ...
        public void GivenElevenValuesShouldReturnAnEnumerableThatProducesTheThreeExpectedResults()
        {
            ...
            var actual = TpzBase32Converter.ConvertToQuintetEnumerable(input);
        ...
        {
            CollectionAssert.IsEmpty(TpzBase32Converter.ConvertToQuintetEnumerable(Enumerable.Empty<bool>()));
        }
        ...
        public void GivenFalseAndTrueShouldReturnAnEnumerableThatProducesOneResultWithTheLowBitOffSecondBitOn()
        {
            ...
            var actual = TpzBase32Converter.ConvertToQuintetEnumerable(new[] { false, true });
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => TpzBase32Converter.ConvertToQuintetEnumerable(null));
        }
        ...
        public void GivenOneFalseValueShouldReturnAnEnumerableThatProducesOneResultWithTheLowBitOff()
        {
            ...
            var actual = TpzBase32Converter.ConvertToQuintetEnumerable(new[] { false });
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        public void GivenOneTrueValueShouldReturnAnEnumerableThatProducesOneResultWithTheLowBitOn()
        {
            ...
            var actual = TpzBase32Converter.ConvertToQuintetEnumerable(new[] { true });
            CollectionAssert.AreEqual(expected, actual);
        }
